    ...
    <b-row class="match-height">
      ...
      >
        <b-card>
          ...
          >
        <h1 class="my-3">OLLO Groups frontend is coming soon!</h1>
          </div>
        </b-card>
      </b-col>
    </b-row>
...
<script lang="jsx">
import {
  BRow, BCol, BCard, BButton, BPopover, BTable, BSpinner, BOverlay,
} from 'bootstrap-vue'
import { CoinGeckoMap, getPairName } from '@/libs/osmos'
import { formatTokenDenom } from '@/libs/utils'
import FeatherIcon from '@/@core/components/feather-icon/FeatherIcon.vue'
import Transact from './components/nft/Transact.vue'
