<template>
  <div className="container-md">
    <b-row class="match-height">
      <b-col md="4" sm="12">
        <b-card>
          <Place :pool.sync="current" :denom-trace="denomTrace" />
        </b-card>
      </b-col>
      <b-col md="8" sm="12">
        <b-card>
          <b-row class="mb-1">
            <b-col lg="4" md="6" sm="12" class="d-flex justify-content-begin align-items-center">
              <b-button id="popover-trading-pairs" variant="gradient-primary">
                <feather-icon icon="ListIcon" />
              </b-button>
            </b-col>
          </b-row>
          <div class="d-flex justify-content-center mt-3">
            <h1>OLLO Dex frontend is coming soon!</h1>
          </div>
        </b-card>
      </b-col>
    </b-row>
