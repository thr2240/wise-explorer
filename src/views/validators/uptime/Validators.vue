<template>
  <div class="container-md px-0">
    <b-row v-if="chainVals">
      <b-col v-for="(x,index) in Object.keys(chainVals)" :key="index" sm="12" md="4" class="text-truncate">
    ...
    <b-alert class="mt-2" variant="success" show>
      ...
      <div class="alert-body">
        ...
        <li> Specify parameters like following:
          <pre>https://ping.pub/cosmos/uptime/my?validators={"sifchain":["FBADE9A30473BB9ED6DFA16BFB3838E028F33650"],"chain_name":["hexAddress"]}</pre>
        </li>
      </div>
    </b-alert>
  </div>
...
import UptimeMyChainBlocks from './Blocks.vue'
